...
function FooterLinks() {
  ...
  return <div className={currentLocal.language==="English"?"footer_links primary-color pr pl":"right_footer_links primary-color pr pl"}>
...
<div className="footer_logo">
          ...
          <div className="footer_pagraph">
            <p className="text-white mt-5 pr-5">{currentLocal.footer.pragraph}</p>
          </div>
...
<Col className=' m-0 p-0 contact_us_menu_col' md={3} style={{paddingBottom:"25px"}}>
<ul className="contact_us_menu">
            <li className="menu_item text-white mb-4">{currentLocal.footer.payment}</li>
            <Container fluid>
              <Row className='p-0'>
