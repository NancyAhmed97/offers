...
function ContactUsForm() {
  ...
  const sendData = (e) => {
    ...
    if (!name || !msg || !email) {
      ...
      // axios({
      //   method: "post",
      //   url: "https://tascerp.com/api/v1/contact",
      //   data: {
      //     name: name,
      //     mobile: phoneNumber,
      //     message: msg,
...
<ul className="p-0 contact_info_container">
        ...
        <li>
          <ul className="p-0 mb-5 touchContainer">
            ...
            <h4 className='m-0 p-0'>{currentLocal.conactus.callHelping}</h4>
              <p> +68 6886 6888</p>
        ...
        <li>
          <ul className="p-0 mb-5 touchContainer">
            ...
            <li className="d-inline-block mx-4 ">
              <h4 className='m-0 p-0'> {currentLocal.conactus.mailInfotitle}</h4>
        ...
        <li>
          <ul className="p-0 mb-5 touchContainer">
            ...
            <li className="d-inline-block mx-4 ">
            <h4 className='m-0 p-0'> {currentLocal.conactus.addresstitle}</h4>
              <p>
              168 King St, Melbourne VIC 5000, Australia
              </p>
            </li>
          </ul>
        </li>
